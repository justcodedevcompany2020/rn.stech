...
export default class App extends Component {
    ...
    redirectToExecutorChatSinglePage = async (user_data) => {
        ...
        this.props.navigation.navigate("ExecutorChatSinglePage", {
            params1: receiver_id,
            params3: user_image,
            params4: user_name,
    ...
    getUsersChat = async () => {
        ...
        try {
            fetch(`${APP_URL}/ChatUser`, {
                ...
                console.log(response, 'tender_data')
            ...
            <SafeAreaView  edges={['right', 'left', 'top']} style={styles.container} >
                    ...
                    >
                        <View style={styles.client_chat_header}>
                            ...
                            <View style={styles.client_chat_buttons_wrapper}>
                                ...
                                <TouchableOpacity style={[styles.client_chat_button ]} onPress={() => {this.redirectToExecutorTendersChat()}}>
                ...
                >
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {this.redirectToExecutorChatSinglePage(support_service)}}
                    >
                                                ...
                                                <View style={styles.client_chat_item_img_info_wrapper}>
                                                    ...
                                                    <View style={styles.client_chat_item_info_box}>
                                                        ...
                                                        {search_item.file &&
                                                            ...
                                                            // <Image style={{width: 35, height: 33}}
                                                            //        source={{uri: this.state.image_path + search_item.file}}/>
                                                        }
                                                    </View>
                                                </View>
                                                <View style={styles.client_chat_item_notification_hour_info_wrapper}>
                                                ...
                                                <View style={styles.client_chat_item_img_info_wrapper}>
                                                    ...
                                                    <View style={styles.client_chat_item_info_box}>
                                                        ...
                                                        {chat_item.file &&
                                                            ...
                                                            // <Image style={{width: 35, height: 33}}
                                                            //        source={{uri: this.state.image_path + chat_item.file}}/>
                                                        }
                                                    </View>
                                                </View>
                                                <View style={styles.client_chat_item_notification_hour_info_wrapper}>
