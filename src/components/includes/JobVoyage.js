...
export default class App extends Component {
        ...
        fetch(`${APP_URL}/getRoleId3Invite`, requestOptions)
            ...
            .then(async response => {
                if (response.hasOwnProperty('status')) {
                    if (response.status === true) {
                        if (response.message == 'You Have Active Job') {
                            if (!response.data.start_job && !response.data.end_job) {
                                this.setState({
                                    start_job: true,
                                    end_job: false,
                                    raice_count: parseInt(response.data.raice_count),
                                    confirm_job_result: false
                                })
                            } else if (response.data.start_job && !response.data.end_job) {
                                await this.setState({
                                    end_job: true,
                                    start_job: false,
                                    raice_count: parseInt(response.data.raice_count),
                            ...
                            } else if (response.data.start_job && response.data.end_job && response.data.status == '2') {

                                await this.setState({
                                    end_job: false,
                                    start_job: false,
                                    job_result_price: parseInt(response.price),
                                    raice_count: parseInt(response.data.raice_count),
                                    confirm_job_result: true,
                ...
                this.setState({
                    ...
                    tender_id: response.data.tender_id,
                    chat_user: response.chatUser
                })
                ...
                if (response.hasOwnProperty('status')) {
                    if (response.status === true) {
                        if (response.data.hasOwnProperty('message')) {
                            if (response.data.message == 'user started job') {
                                await this.setState({
                                    confirmBeginningOfWorkPopup: false,
                                    end_job: true,
                                    start_job: false,
    ...
    endJob = async () => {
        ...
        // console.log(AuthStr, parseFloat(location.coords.latitude), parseFloat(location.coords.longitude), 'baaaaaaaaaaaa')
            ...
            async (position) => {
                ...
                try {
                    fetch(`${APP_URL}/endJob`, {
                        ...
                        console.log(response, 'fulEndJobREsponce')
                        await  this.setState({
                            loaded_result: false,
                        })
                        ...
                        if (response.hasOwnProperty('status')) {
                            if (response.status === true) {
                                this.setState({
                                    // job_result: response.data,
                                    confirmEndOfWorkPopup : false,
                                    end_job: false,
                                    start_job: false,
                                    job_result_price: response?.data?.price,
                                    confirm_job_result: true,
                                    raice_count: response?.data?.jobRaice,
                                })
    ...
    openChat = () => {
        ...
        let tender_id = this.state.tender_id;
        let chat_user = this.state.chat_user;

        if (tender_id) {
            this.props.navigation.navigate("ExecutorTenderChatSinglePage", {
                params1: chat_user.id,
                params2: tender_id,
                params3: chat_user.photo,
                params4: chat_user.name,
                redirect_from_timer: 'true',
                redirect_from_type: 'from job raice',
                ...
                if (response.hasOwnProperty('status')) {
                    if (response.status === true) {
                        if (response.hasOwnProperty('message')) {
                            if (response.message == 'Caunt Added') {
                                this.setState({
                                    raice_count: response.count,
                                    raice_price: response.price,
                                })
                            }
                        }
                    }
    ...
    render() {
        ...
        if (this.state.confirmBeginningOfWorkPopup) {
            return (
                <ImageBackground resizeMode="cover" source={require('../../assets/images/popup_img.png')} style={[styles.onlinePaymentMethodPopup,{width: '100%', height: windowHeight,  zIndex: 99999999, }]}>
                    <View style={styles.online_payment_method_popup_wrapper}>
                        <TouchableOpacity style={styles.online_payment_method_popup_close_btn} onPress={() => {this.setState({confirmBeginningOfWorkPopup: false})}}>
                            <Svg
                                width={30}
                                height={30}
                                viewBox="0 0 30 30"
                        ...
                        <View style={styles.online_payment_method_popup_img}>
                            <Svg
                                width={108}
                                height={88}
                                viewBox="0 0 108 88"
                            ...
                            >
                                ...
                                <Path
                                    ...
                                    mask="url(#a)"
                                />
                                <G clipPath="url(#clip0_150_2998)">
                                    <Path
                                        d="M33.937 40.112c0-.66.124-1.28.373-1.86a4.876 4.876 0 011.01-1.514 4.845 4.845 0 011.506-1.036 4.49 4.49 0 011.835-.378h7.229v3.196h-7.23a1.545 1.545 0 00-1.12.468c-.14.14-.249.308-.33.5-.08.194-.12.402-.12.624 0 .223.04.435.12.635.081.193.19.364.33.513.147.14.315.252.505.334.19.081.396.122.616.122h3.153c.652 0 1.263.126 1.834.379.58.245 1.08.586 1.506 1.024.432.431.769.94 1.01 1.526.25.58.374 1.2.374 1.86 0 .66-.125 1.28-.374 1.86a4.762 4.762 0 01-1.01 1.526c-.425.43-.927.772-1.506 1.024a4.487 4.487 0 01-1.834.379h-6.999v-3.197h6.999a1.544 1.544 0 001.11-.456 1.601 1.601 0 00.46-1.136c0-.223-.04-.43-.12-.624a1.477 1.477 0 00-.34-.5 1.456 1.456 0 00-.495-.346 1.544 1.544 0 00-.615-.123H38.66a4.488 4.488 0 01-1.835-.378 4.938 4.938 0 01-1.505-1.025 5.015 5.015 0 01-1.01-1.526 4.736 4.736 0 01-.374-1.87zm21.071 11.182h-3.142V38.52h-4.735v-3.196h12.602v3.196h-4.725v12.774zm17.194 0h-10.8v-15.97h10.8v3.196h-7.647v3.196h5.175v3.196h-5.175v3.185h7.647v3.197zm14.392-1.637a8.002 8.002 0 01-2.46 1.47 7.956 7.956 0 01-2.824.512c-.747 0-1.469-.1-2.165-.3a8.21 8.21 0 01-1.944-.825 8.567 8.567 0 01-2.933-2.974 8.814 8.814 0 01-.825-1.97 8.385 8.385 0 01-.285-2.194c0-.758.095-1.49.285-2.194a8.532 8.532 0 01.824-1.972 8.422 8.422 0 011.286-1.681 8.157 8.157 0 013.592-2.128 7.78 7.78 0 012.165-.3c.974 0 1.915.17 2.823.512a7.72 7.72 0 012.46 1.47l-1.669 2.784a4.653 4.653 0 00-1.637-1.158 4.895 4.895 0 00-1.977-.412c-.696 0-1.348.134-1.956.401a5.093 5.093 0 00-2.67 2.706 4.957 4.957 0 00-.395 1.971c0 .698.132 1.355.395 1.972a5.206 5.206 0 001.077 1.603c.454.46.985.825 1.593 1.092.608.267 1.26.4 1.956.4a5.01 5.01 0 001.977-.4 4.78 4.78 0 001.637-1.17l1.67 2.785zm4.988 1.637h-3.153v-15.97h3.153v6.392h6.295v-6.392h3.153v15.97h-3.153v-6.382h-6.295v6.382z"
                                        fill="#333"
                                    />
                                </G>
                                <Defs>
                                    <ClipPath id="clip0_150_2998">
                                        <Path
                                            fill="#fff"
                        ...
                        <Text style={styles.online_payment_method_popup_title}>
                            Подтвердите
                            начало работы
                        </Text>
                        <TouchableOpacity style={styles.go_to_single_product_btn} onPress={() => {this.startJob()}}>
                            <Text style={styles.go_to_single_product_btn_text}>Подтвердить</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.not_go_to_single_product_btn} onPress={() => {this.setState({confirmBeginningOfWorkPopup: false})}}>
        ...
        if (this.state.confirmEndOfWorkPopup) {
            return (
                <ImageBackground resizeMode="cover" source={require('../../assets/images/popup_img.png')} style={[styles.onlinePaymentMethodPopup,{width: '100%', height: windowHeight,  zIndex: 99999999, }]}>
                    <View style={styles.online_payment_method_popup_wrapper}>
                        <TouchableOpacity style={styles.online_payment_method_popup_close_btn} onPress={() => {this.setState({confirmEndOfWorkPopup: false})}}>
                            <Svg
                                width={30}
                                height={30}
                                viewBox="0 0 30 30"
                        ...
                        <TouchableOpacity style={styles.go_to_single_product_btn} onPress={() => {this.endJob()}}>
                            <Text style={styles.go_to_single_product_btn_text}>Подтвердить</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.not_go_to_single_product_btn} onPress={() => {this.setState({confirmEndOfWorkPopup: false})}}>
                            <Text style={styles.not_go_to_single_product_btn_text}>Отменить</Text>
                        </TouchableOpacity>
        ...
        return (
            <SafeAreaView  edges={['right', 'left', 'top']} style={styles.container} >
                ...
                <ImageBackground resizeMode="cover" source={require('../../assets/images/timer_img.png')} style={[{width: '100%', height: '100%',  zIndex: 99999999, }]}>


                    <View
                        style={styles.catalogue_header}
                        onLayout={(event) => {
                    ...
                    >
                        <View style={styles.catalogue_header_img_info_wrapper}>
                            <View style={styles.catalogue_header_img}>
                                <Image style={styles.catalogue_header_img_child}  source={{uri: this.state.image_path + this.state.executor_main_page_info.photo}} />
                            </View>
                            <View style={styles.catalogue_header_info}>
                                <Text style={styles.catalogue_header_info1}>{this.state.executor_main_page_info.balance} р.</Text>
                                <Text style={styles.catalogue_header_info2}>Баланс</Text>
                            </View>
                        </View>
                        <View style={styles.catalogue_header_logo_rating_info_activity_info_wrapper}>
                            <View style={styles.catalogue_header_logo}>
                                <Svg width={65} height={16} viewBox="0 0 65 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <Path d="M.18 4.817c0-.635.12-1.23.36-1.787.24-.557.564-1.042.973-1.456.416-.42.899-.753 1.45-.995A4.33 4.33 0 014.728.215h6.961v3.071H4.73a1.49 1.49 0 00-1.08.45 1.537 1.537 0 00-.434 1.08c.001.215.04.418.117.61.078.186.184.35.318.493.14.136.303.243.486.321.184.079.381.118.593.118h3.036a4.33 4.33 0 011.767.364c.557.235 1.04.564 1.45.984.415.414.74.903.973 1.467.24.556.36 1.152.36 1.787s-.12 1.23-.36 1.787a4.576 4.576 0 01-.974 1.466c-.409.414-.892.742-1.45.985a4.33 4.33 0 01-1.766.364H1.026V12.49h6.74a1.49 1.49 0 001.068-.438 1.538 1.538 0 00.444-1.092c0-.214-.039-.414-.116-.6a1.42 1.42 0 00-.328-.481 1.402 1.402 0 00-.476-.332 1.49 1.49 0 00-.593-.118H4.73a4.33 4.33 0 01-1.767-.363 4.757 4.757 0 01-1.45-.985A4.82 4.82 0 01.54 6.615a4.545 4.545 0 01-.36-1.798zM20.47 15.562h-3.026V3.287h-4.56V.215H25.02v3.072h-4.549v12.275zm16.557 0h-10.4V.215h10.4v3.072h-7.363v3.071h4.982v3.071h-4.982v3.061h7.363v3.072zm13.859-1.573a7.71 7.71 0 01-2.37 1.412 7.677 7.677 0 01-2.719.492c-.72 0-1.414-.096-2.084-.288a7.915 7.915 0 01-1.873-.792 8.238 8.238 0 01-2.825-2.857 8.458 8.458 0 01-.793-1.895 8.04 8.04 0 01-.275-2.108c0-.728.092-1.43.275-2.109.19-.678.455-1.309.794-1.894a8.096 8.096 0 011.237-1.616A7.848 7.848 0 0143.715.29 7.504 7.504 0 0145.798 0c.938 0 1.844.164 2.72.492a7.438 7.438 0 012.369 1.413L49.279 4.58a4.482 4.482 0 00-1.577-1.113 4.722 4.722 0 00-1.904-.396c-.67 0-1.298.129-1.883.386a4.907 4.907 0 00-2.57 2.6 4.754 4.754 0 00-.381 1.895c0 .67.126 1.302.38 1.894.254.585.6 1.099 1.037 1.541.437.442.949.792 1.534 1.049a4.635 4.635 0 001.883.385c.663 0 1.298-.128 1.904-.385a4.604 4.604 0 001.577-1.124l1.608 2.676zm4.803 1.573h-3.036V.215h3.036v6.143h6.062V.215h3.036v15.347h-3.036V9.429H55.69v6.133z" fill="#F60"/>
                                </Svg>
                            </View>
                            <View style={styles.catalogue_header_rating_info_activity_info_wrapper}>
                                <View style={styles.catalogue_header_activity_info_wrapper}>
                                    <Text style={styles.catalogue_header_activity_title}>Активность</Text>
                                    <Text style={styles.catalogue_header_activity_info}>{this.state.executor_main_page_info.activity}</Text>
                                </View>
                                <View style={styles.catalogue_header_rating_info_wrapper}>
                                    <Text style={styles.catalogue_header_rating_title}>Рейтинг</Text>
                                    <Text style={styles.catalogue_header_rating_info}>{this.state.review ? parseFloat(this.state.review).toFixed(1) : 5.0}</Text>
                                </View>
                    ...
                    <KeyboardAwareScrollView
                        style={styles.timer_main_wrapper}
                        enableOnAndroid={true}
                        enableAutomaticScroll={(Platform.OS === 'ios')}
                    >

                        {this.state.start_job &&
                        <Text style={styles.timer_main_title}>Хорошей работы</Text>
                        }

                        {this.state.end_job  &&
                        <Text style={styles.timer_main_title}>Количество рейсов</Text>
                        }



                        {this.state.confirm_job_result &&
                        <View style={styles.confirm_job_result_info_wrapper}>
                            <Text style={styles.confirm_job_result_info_title}>К оплате</Text>
                            <Text style={styles.confirm_job_result_info_text}>
                                {this.state.job_result_price}
                                <View style={{paddingLeft: 5}}>
                                    ...
                                    >
                                        <Path
                                            d="M13.767 16.001c2.385.054 4.697-.758 6.427-2.258 1.731-1.499 2.74-3.564 2.806-5.741-.066-2.178-1.075-4.242-2.806-5.742-1.73-1.5-4.042-2.311-6.427-2.257H4.381c-.29 0-.57.105-.775.292a.958.958 0 00-.32.707v13h-2.19c-.291 0-.57.105-.775.292a.958.958 0 00-.321.707c0 .265.115.52.32.707.206.188.485.293.775.293h2.19v2h-2.19c-.29 0-.569.105-.774.293A.958.958 0 000 19c0 .265.115.52.32.707.206.187.485.293.775.293h2.19v7c0 .264.116.519.321.706.206.188.484.293.775.293.29 0 .569-.105.774-.293A.958.958 0 005.476 27v-7h9.857c.29 0 .57-.105.775-.292a.958.958 0 00.32-.707.958.958 0 00-.32-.707 1.15 1.15 0 00-.775-.293H5.476v-2h8.291zM5.477 2.002h8.29c1.804-.051 3.556.551 4.876 1.675 1.32 1.124 2.098 2.679 2.166 4.325-.065 1.647-.843 3.203-2.163 4.328-1.32 1.124-3.074 1.725-4.879 1.671h-8.29V2.002z"
                                            fill="#333"
                                        />
                                    </Svg>
                                </View>
                        ...
                        <View style={{marginBottom: this.state.end_job ? 30 : 50}}>
                            <LinearGradient
                                // Button Linear Gradient
                                colors={['#FF6600', '#DAD100']}
                                style={[styles.timer_box, {marginBottom: 15}]}
                            >
                                <View style={styles.timer_box_child}>
                                    <Text style={styles.timer_box_title}>{this.state.raice_count}</Text>
                                </View>
                            ...
                            {this.state.end_job &&
                                <View style={{flexDirection: 'row', alignItems: 'center', alignSelf: 'center'}}>
                                    <TouchableOpacity style={[styles.plus_raice_btn, {marginRight: 20}]}
                                        onPress={() => {
                                            this.removeRaice()
                                        }}
                                    >
                                        ...
                                        >
                                            <Path
                                                d="M459.313 229.648c0 22.201-17.992 40.199-40.205 40.199H40.181c-11.094 0-21.14-4.498-28.416-11.774C4.495 250.808 0 240.76 0 229.66c-.006-22.204 17.992-40.199 40.202-40.193h378.936c22.195.005 40.17 17.989 40.175 40.181z"/>
                                        </Svg>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.plus_raice_btn} onPress={() => {
                                        this.addRaice()
                                    }}>
                                        <Svg
                                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        {this.state.start_job  &&
                        <TouchableOpacity style={styles.timer_get_started_button} onPress={() => {this.setState({confirmBeginningOfWorkPopup: true})}}>
                            <Text style={styles.timer_get_started_button_text}>Начать работу</Text>
                        </TouchableOpacity>
                        }

                        {this.state.end_job &&
                        <TouchableOpacity style={styles.timer_get_started_button} onPress={() => {this.setState({confirmEndOfWorkPopup: true})}}>
                            <Text style={styles.timer_get_started_button_text}>Завершить работу</Text>
                        </TouchableOpacity>
                        }

                        {this.state.confirm_job_result &&
                            <TouchableOpacity style={styles.timer_get_started_button} onPress={() => {this.confirmJob()}}>
                                <Text style={styles.timer_get_started_button_text}>Подтвердить</Text>
                            </TouchableOpacity>
                        }

                        {/*{this.state.confirm_job_result && this.state.show_confirm_job_button &&*/}

                        {/*<TouchableOpacity style={[styles.timer_get_started_button, {opacity: 0.5}]} >*/}
                        {/*    <Text style={styles.timer_get_started_button_text}>Подтвердить</Text>*/}
                        {/*</TouchableOpacity>*/}
                        ...
                        <TouchableOpacity style={[styles.timer_get_started_button, {marginTop: 15}]} onPress={() => {this.openChat()}}>
                            <Text style={styles.timer_get_started_button_text}>Открыть чат</Text>
                        </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    catalogue_header_img_info_wrapper: {
        position:'relative',
        top: 13,
        flexDirection: 'row',
        alignItems: 'center',
    },
    catalogue_header_img: {
        width: 55,
        height: 55,
        marginRight: 10,

    },
    catalogue_header_img_child: {
        width: '100%',
        height: '100%',
        borderRadius: 100,
        overflow: 'hidden',
    ...
    catalogue_header_info1: {
        fontWeight: '700',
        fontSize: 22,
        color: '#333333',
    },
    catalogue_header_info2: {
        fontWeight: '300',
        fontSize: 15,
        color: '#333333',
    },
    catalogue_header_logo: {
        marginBottom: 8,
        alignItems: 'flex-end',
    },
    catalogue_header_rating_info_activity_info_wrapper: {
        flexDirection: 'row',
        alignItems: 'center',
    },
    catalogue_header_activity_info_wrapper: {
        paddingHorizontal: 5,
        borderWidth: 1,
        borderColor: '#FF6600',
        paddingVertical: 0,
    ...
    catalogue_header_activity_title: {
        fontWeight: '300',
        fontSize: 10,
        color: '#333333',
    },
    catalogue_header_activity_info: {
        fontWeight: '400',
        fontSize: 22,
        color: '#333333',
    },
    catalogue_header_rating_info_wrapper: {
        backgroundColor: '#FF6600',
        borderRadius: 6,
        alignItems: 'center',
        justifyContent: 'center',
    ...
    catalogue_header_rating_title: {
        fontWeight: '300',
        fontSize: 10,
        color: '#ffffff',
    },
    catalogue_header_rating_info: {
        fontWeight: '400',
        fontSize: 22,
        color: '#ffffff',
    },
    online_payment_method_popup_button: {
        backgroundColor: '#FF6600',
        borderRadius: 6,
        height: 50,
        width: 265,
    ...
    online_payment_method_popup_button_text: {
        color: '#ffffff',
        fontWeight: '700',
        fontSize: 18,
    },
    online_payment_method_popup_wrapper: {
        position: 'relative',
        paddingTop: 78,
        paddingBottom: 61,
    ...
    online_payment_method_popup_close_btn: {
        position: 'absolute',
        top: 21,
        right: 21,
    },
    online_payment_method_popup_img: {
        marginBottom: 20,
    },
    online_payment_method_popup_title: {
        fontSize: 26,
        fontWeight: '400',
        color: '#333333',
        textAlign: 'center',
    ...
    online_payment_method_popup_info: {
        fontSize: 16,
        fontWeight: '400',
        color: '#FF6600',
        textAlign: 'center',
    ...
    timer_get_started_button_text: {
        color: '#ffffff',
        fontWeight: '700',
        fontSize: 18,
    },
    confirm_job_result_info_title: {
        color: '#333333',
        fontSize: 24,
        fontWeight: '300',
    ...
    confirm_job_result_info_text: {
        color: '#333333',
        fontSize: 40,
        fontWeight: '400',
    },

    confirm_job_result_info_wrapper: {
        justifyContent: 'center',
        alignItems: 'center',
        alignSelf: 'center',
        marginBottom: 57
