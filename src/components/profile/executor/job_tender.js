            ...
            <SafeAreaView  edges={['right', 'left', 'top']} style={styles.container} >
                <StatusBar style="dark" />
                    ...
                    <View style={styles.footer}>
                        ...
                        <TouchableOpacity style={[styles.footer_btn, {position:'relative', }]} onPress={() => {this.redirectToExecutorCatalogueMainPage()}}>
                        ...
                        <TouchableOpacity style={[styles.footer_btn, {position:'relative', }]} onPress={() => this.redirectToExecutorPersonalArea()}>
