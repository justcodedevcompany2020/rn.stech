...
export default class App extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            keyboardOffset: this.props.redirect_from_timer == "true" ? 10 : 92,
            keyboardOpen: false,
            message_error: false,
            message_error_text: '',
            ...
            redirect_from_timer: this.props.redirect_from_timer,
            ...
            try {
                fetch(`${APP_URL}/createNewMessageTender`, {
                    ...
                    if (response.status === true) {
                        ...
                        if (response.hasOwnProperty('data')) {
                            if ( response.data.message == 'Подождите пока заказчики ответит вам') {
                                await this.setState({
                                    messageInput: '',
                                    loading_message: false,
    ...
    redirectToExecutorTenderChat = () => {
        clearInterval(this.interval)
        this.props.navigation.navigate("ExecutorTendersChat");
    }
    redirectToJobTimer = () => {
        clearInterval(this.interval)
        let redirect_from_type = this.props.redirect_from_type
        if (redirect_from_type == 'from job timer') {
            this.props.navigation.navigate("JobTimer");
        } else if (redirect_from_type == 'from job raice') {
            this.props.navigation.navigate("JobVoyage");
        }
    ...
    findTenderMessage = (messages) => {
        let message = '';
       // alert(messages.indexOf('barevvvvvvvvvv'))
            if (messages.indexOf('Откликнулся на ваш тендер') != -1) {
                message = 'Ваш отклик'
            } else {
                message = messages
            }
    ...
    render() {
                    ...
                    <View style={styles.single_product_popup_wrapper}>
                        ...
                        <TouchableOpacity style={styles.single_product_popup_close_btn} onPress={() => {this.setState({confirmSelectionPerformerPopup: false})}}>
                            <Svg width={30} height={30} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <Path d="M4.024 5.351a.938.938 0 111.327-1.327l9.65 9.65 9.648-9.65a.938.938 0 111.328 1.327L16.326 15l9.65 9.649a.937.937 0 01-.663 1.602.94.94 0 01-.664-.275L15 16.326l-9.649 9.65a.94.94 0 01-1.53-.304.938.938 0 01.203-1.023L13.674 15l-9.65-9.649z" fill="#888"/>
                            </Svg>
                        </TouchableOpacity>
        ...
        //
        // if (this.state.wait_for_client_answer_note) {
        //     return (
        //
        //
        //
        ...
        return (
            <SafeAreaView  edges={['right', 'left', 'top']} style={styles.container} >
                ...
                <View style={{ overflow: 'hidden', paddingBottom: 5, width: '100%' }}>
                    ...
                    >
                        ...
                        <View style={styles.client_chat_header}>
                            ...
                            {this.state.redirect_from_timer == 'false' &&

                                <TouchableOpacity  onPress={() => {this.redirectToExecutorTenderChat()}}>
                            ...
                            {this.state.redirect_from_timer == "true" &&

                                <TouchableOpacity  onPress={() => {this.redirectToJobTimer()}}>
                                    <Svg width={35} height={35} viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <Path d="M20.169 27.708a1.458 1.458 0 01-1.138-.54l-7.043-8.75a1.458 1.458 0 010-1.851l7.291-8.75a1.46 1.46 0 112.246 1.866L15.006 17.5l6.3 7.817a1.458 1.458 0 01-1.137 2.391z" fill="#000"/>
                                    </Svg>
                                </TouchableOpacity>
                ...
                {this.state.show_important_message &&
                                ...
                                {this.state.user_id == chat_item.receiver_id ?
                                    ...
                                    <View style={{alignItems: 'flex-end', width: '100%'}}>
                                        ...
                                        <View  style={styles.client_chat_messages_item_send}>
                                            {/*<Text  style={styles.client_chat_message}>{chat_item.messages}</Text>*/}
                                            <Text  style={[styles.client_chat_message, {color: '#ffffff'}]}>{this.findTenderMessage(chat_item.messages)}</Text>
                                            <Svg
                ...
                {this.state.keyboardOpen === false &&  this.state.redirect_from_timer == 'false' &&
                ...
                {this.state.wait_for_client_answer_note &&

                    <View style={styles.client_answer_popup}>
                        <View style={styles.client_answer_popup_wrapper}>
                            <Text style={styles.client_answer_popup_info}>
                                Отправка сообщений не доступна пока клиент не ответит вам!
                            </Text>
                        </View>
                    </View>
                }
