...
export default class App extends Component {
    ...
    componentDidMount() {
        ...
        } else if (this.props.category_id && this.props.subcategory_id === null) {
            this.getExecutorsListWithoutSubCategoryId();
        }
        // this.getCategories();
        // if (this.props.category_id && this.props.subcategory_id) {
        //     this.getExecutorsList();
        ...
        console.log(this.props.category_id, this.props.subcategory_id, 'propssssssssssssssssssssssssssssssss')
    ...
    getExecutorsList = async () => {
        ...
        console.log(subcategory_id, category_id, 'hhhhhhhhhhh');
        ...
        async (position) => {
            ...
            try {
                fetch(`${APP_URL}/FilterUsers?page=1`, {
                    ...
                    console.log(response, 'hddddddddddddddddddd')
                    await this.setState({
                        loader: false
                    })
                    if (response.status === true)
    ...
    loadMoreExecutorsList = async () => {
        ...
        let userToken = await AsyncStorage.getItem('userToken');
        let AuthStr = 'Bearer ' + userToken;
        let {next_page_url, executors_list, latitude, longitude, current_page, last_page} = this.state;
