...
export default class App extends Component {
    ...
    async checkPopupStatus() {
        ...
        try {
            const itemKey = `popupShown_${receiver_id}`;
    ...
    getAllMessages = async (onScroll = false) => {
        ...
        try {
            fetch(`${APP_URL}/OnePageMessage`, {
                ...
                console.log(response, 'GetAllMessage')
        ...
        return (
            <SafeAreaView  edges={['right', 'left', 'top']} style={styles.container} >
                ...
                {this.state.invite == 'no invite'  && this.state.balance >= 0 && this.state.user_name != 'Cлужба поддержки' &&
                    <View
                        style={[styles.single_product_page_write_message_btn_parent,  Platform.OS === 'ios' && {top:120}]}
                    >
                                    ...
                                    <View style={{alignItems: 'flex-end', width: '100%'}}>
                                        ...
                                        {chat_item.message  &&
                                         <View  style={styles.client_chat_messages_item_send}>
                                            <Text  style={[styles.client_chat_message, {color: '#ffffff'}]}>{chat_item.message}</Text>
                                        ...
                                        {chat_item.file &&
                                            <TouchableOpacity  style={[styles.client_chat_messages_item_send_img,]}
