...
// import MapView, {Marker, PROVIDER_GOOGLE, PROVIDER_DEFAULT, LocalTile, ProviderPropType, UrlTile,} from 'react-native-maps';
...
import NotificationController from "../../notifications/NotificationController.android";
import NotificationControllerTest from "../../notifications/NotificationControllerTest";
...
export default class App extends Component {
    constructor(props) {
        ...
        this.state = {
            searchInput: '',
            catalogue_list: false,
            catalogue_map: true,

            catalogue_list_items: [
                {
                    id: 1,
                    img: require('../../../assets/images/catagory_img1.png'),
                    catalogue_list_name: 'Перевозки',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img1.png'),
                            subcategories_list_name: 'Газель \n до 1 т.',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                                    product_type_name: 'Трактор',
                                    product_rating: '4.9',
                                    product_type_img: [
                                        require('../../../assets/images/product_img1.png'),
                                        require('../../../assets/images/product_img2.png'),
                                        require('../../../assets/images/product_img3.png'),
                                        require('../../../assets/images/product_img4.png'),
                                    ],
                                    product_distance_info: '9',
                                    product_price: '1000',
                                },
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img2.png'),
                                    product_owner_name: 'Сергей Алексеев',
                                    product_type_name: 'Трактор',
                                    product_rating: '4.6',
                                    product_type_img: [
                                        require('../../../assets/images/product_img1.png'),
                                    ...
                                    product_distance_info: '11',
                                    product_price: '1000',
                                },
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img3.png'),
                                    product_owner_name: 'Алексей Бычков',
                                    product_type_name: 'Трактор',
                                    product_rating: '4.8',
                                    product_type_img: [
                                        require('../../../assets/images/product_img1.png'),
                        ...
                        {
                            id:2,
                            img: require('../../../assets/images/subcategory_img2.png'),
                            subcategories_list_name: 'Газель \n до 2 т.',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                        ...
                        {
                            id:3,
                            img: require('../../../assets/images/subcategory_img3.png'),
                            subcategories_list_name: 'Газель \n до 3.5 т.',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                        ...
                        {
                            id:4,
                            img: require('../../../assets/images/subcategory_img4.png'),
                            subcategories_list_name: 'Грузовик\n до 5 т.',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:5,
                            img: require('../../../assets/images/subcategory_img5.png'),
                            subcategories_list_name: 'Грузовик\n до 10 т.',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                        ...
                        {
                            id:6,
                            img: require('../../../assets/images/subcategory_img6.png'),
                            subcategories_list_name: 'Грузовик\n до 20 т.',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                        ...
                        {
                            id:7,
                            img: require('../../../assets/images/subcategory_img7.png'),
                            subcategories_list_name: 'Газель \n бортовая',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                        ...
                        {
                            id:8,
                            img: require('../../../assets/images/subcategory_img8.png'),
                            subcategories_list_name: 'Длинный \n борт',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                ...
                {
                    id: 2,
                    img: require('../../../assets/images/catagory_img2.png'),
                    catalogue_list_name: 'Строительная техника',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img14.png'),
                            subcategories_list_name: 'Экскаватор \n погрузчик',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:2,
                            img: require('../../../assets/images/subcategory_img10.png'),
                            subcategories_list_name: 'Автобетоно насос',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:3,
                            img: require('../../../assets/images/subcategory_img11.png'),
                            subcategories_list_name: 'Автокран',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:4,
                            img: require('../../../assets/images/subcategory_img12.png'),
                            subcategories_list_name: 'Бетоновозы',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:5,
                            img: require('../../../assets/images/subcategory_img13.png'),
                            subcategories_list_name: 'Бульдозеры',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:6,
                            img: require('../../../assets/images/subcategory_img9.png'),
                            subcategories_list_name: 'Экскаваторы',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:7,
                            img: require('../../../assets/images/subcategory_img15.png'),
                            subcategories_list_name: 'Катки',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                ...
                {
                    id: 3,
                    img: require('../../../assets/images/catagory_img3.png'),
                    catalogue_list_name: 'Самосвалы',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img1.png'),
                        ...
                        },
                        {
                            id:8,
                            img: require('../../../assets/images/subcategory_img8.png'),
                            subcategories_list_name: 'Длинный борт',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                ...
                {
                    id: 4,
                    img: require('../../../assets/images/catagory_img.png'),
                    catalogue_list_name: 'Манипуляторы',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img9.png'),
                        ...
                        },
                        {
                            id:6,
                            img: require('../../../assets/images/subcategory_img14.png'),
                            subcategories_list_name: 'Гидромолот',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                ...
                {
                    id: 5,
                    img: require('../../../assets/images/catagory_img5.png'),
                    catalogue_list_name: 'Эвакуаторы',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img1.png'),
                ...
                {
                    id: 6,
                    img: require('../../../assets/images/category_img6.png'),
                    catalogue_list_name: 'Бытовая техника',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img16.png'),
                            subcategories_list_name: 'Мусоровоз',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:2,
                            img: require('../../../assets/images/subcategory_img17.png'),
                            subcategories_list_name: 'Автоцистерна',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:3,
                            img: require('../../../assets/images/subcategory_img18.png'),
                            subcategories_list_name: 'Бытовая техника',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:4,
                            img: require('../../../assets/images/subcategory_img19.png'),
                            subcategories_list_name: 'Ассенизаторы',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:5,
                            img: require('../../../assets/images/subcategory_img20.png'),
                            subcategories_list_name: 'Коммунально \n дорожные',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                ...
                {
                    id: 7,
                    img: require('../../../assets/images/category_img7.png'),
                    catalogue_list_name: 'Яморубы и сваебои',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img1.png'),
                ...
                {
                    id: 8,
                    img: require('../../../assets/images/category_img9.png'),
                    catalogue_list_name: 'Мини техника',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img21.png'),
                            subcategories_list_name: 'Мини погрузчики',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:2,
                            img: require('../../../assets/images/subcategory_img22.png'),
                            subcategories_list_name: 'Мини экскаваторы',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:3,
                            img: require('../../../assets/images/subcategory_img23.png'),
                            subcategories_list_name: 'Мини самосвалы',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                        ...
                        {
                            id:4,
                            img: require('../../../assets/images/subcategory_img24.png'),
                            subcategories_list_name: 'Мини миксера',
                            products: [
                                {
                                    product_owner_img: require('../../../assets/images/product_owner_img1.png'),
                                    product_owner_name: 'Александр Смирнов',
                ...
                {
                    id: 9,
                    img: require('../../../assets/images/category_img8.png'),
                    catalogue_list_name: 'Спец инструмент',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img16.png'),
                ...
                {
                    id: 10,
                    img: require('../../../assets/images/category_img10.png'),
                    catalogue_list_name: 'Леса,опалубка и т.д.',
                    subcategories: [
                        {
                            id:1,
                            img: require('../../../assets/images/subcategory_img16.png'),
            ...
            isOpenOptionalEquipmentDropDown6: false,
            optionalEquipmentItems6:[
                {label: ' Водный транспорт', value: ' Водный транспорт'},
                {label: 'Aвиация', value: 'Aвиация'},
                {label: 'Автомобильный', value: 'Автомобильный'},
                {label: 'Трактор', value: 'Трактор'},
            ...
            selectedOptionalEquipment6: null,
            selectedOptionalEquipmentLabel6: '',

            isOpenOptionalEquipmentDropDown7: false,
            optionalEquipmentItems7:[
                {label: ' Водный транспорт', value: ' Водный транспорт'},
                {label: 'Aвиация', value: 'Aвиация'},
                {label: 'Автомобильный', value: 'Автомобильный'},
                {label: 'Трактор', value: 'Трактор'},
            ...
            selectedOptionalEquipment7: null,
            selectedOptionalEquipmentLabel7: '',

            isOpenOptionalEquipmentDropDown8: false,
            optionalEquipmentItems8:[
                {label: ' Водный транспорт', value: ' Водный транспорт'},
                {label: 'Aвиация', value: 'Aвиация'},
                {label: 'Автомобильный', value: 'Автомобильный'},
                {label: 'Трактор', value: 'Трактор'},
            ...
            selectedOptionalEquipment8: null,
            selectedOptionalEquipmentLabel8: '',

            isOpenOptionalEquipmentDropDown9: false,
            optionalEquipmentItems9:[
                {label: ' Водный транспорт', value: ' Водный транспорт'},
                {label: 'Aвиация', value: 'Aвиация'},
                {label: 'Автомобильный', value: 'Автомобильный'},
                {label: 'Трактор', value: 'Трактор'},
            ...
            selectedOptionalEquipment9: null,
            selectedOptionalEquipmentLabel9: '',


            isOpenOptionalEquipmentDropDown10: false,
            optionalEquipmentItems10:[
                {label: ' Водный транспорт', value: ' Водный транспорт'},
                {label: 'Aвиация', value: 'Aвиация'},
                {label: 'Автомобильный', value: 'Автомобильный'},
                {label: 'Трактор', value: 'Трактор'},
            ...
            selectedOptionalEquipment10: null,
            selectedOptionalEquipmentLabel10: '',
            ...
            filter_latitude: null,
            filter_longitude: null,
            filter_initialRegion:  {
                latitude:  55.751244,
                longitude: 37.618423,
                latitudeDelta: 1,
                longitudeDelta: 1,
            ...
            selectedItemRadius: 'Выберите радиус',
            selectedItemRadius_error: false,
            selectedItemRadius_error_text: '',
            radius_info: [
               '5 км', '10 км', '20 км', '30 км'
            ],
            loaded_filter_map: false,
            filter_map: false,

            latitude_longitude_error: false,
            latitude_longitude_error_text: '',
            filter_users: [],

            openRadius: false,
            selectedRadius: 'Выберите радиус',
    ...
    pressedCategory = (item) => {
        ...
        let catalogue_list_name = item.catalogue_list_name;
        this.setState({
            is_pressed_category: true,
            selected_subcategories: subcategories,
            main_title: catalogue_list_name,
        })
    ...
    // This function is works when the page is opening. It opens the general map and shows active users
    openMap = async () => {
        ...
        try {
            Geolocation.getCurrentPosition(
                async (position) => {
                    ...
                    console.log(this.state.initialRegion , 'initialRegion')

                    let userToken = await AsyncStorage.getItem('userToken');
                    let AuthStr = 'Bearer ' + userToken;

                    try {
                        fetch(`${APP_URL}/ActiveRoleId3List`, {
                            method: 'POST',
                            headers: {
                            ...
                            if (response.status === true) {
                                this.setState({
                                    active_executors: response.data,
                                    catalogue_list: false,
                                })
                            }
                        })
    ...
    applyFilter = async () => {
        ...
        let {selectedItemTransport, selectedItemTransportSubCategory, category_id,selected_subcategory_id,selectedItemRadius, filter_latitude, filter_longitude} = this.state;


        if (selectedItemTransport == 'Выберите тип транспорта' || filter_latitude == null || filter_longitude == null || selectedItemRadius == 'Выберите радиус') {
            ...
            if (filter_latitude == null && filter_longitude) {
                this.setState({
                    latitude_longitude_error: true,
                    latitude_longitude_error_text: 'Дождитесь инициализации карты',
                })
            }  else {
                this.setState({
                    latitude_longitude_error: false,
            ...
            if (selectedItemRadius == 'Выберите радиус') {
                this.setState({
                    selectedItemRadius_error: true,
                    selectedItemRadius_error_text: 'Поле является обязательным.',
                })
            } else {
                this.setState({
                    selectedItemRadius_error: false,
            ...
            try {
                fetch(`${APP_URL}/FilterUsersNOPaginate`, {
                    method: 'POST',
                    headers: {
                        'Authorization': AuthStr,
                        'Accept': 'application/json',
                    ...
                    body: JSON.stringify({
                        ...
                        sub_category_id: selected_subcategory_id,
                        latitude: filter_latitude,
                        longitude: filter_longitude,
                    ...
                    if (response.status === true) {
                        ...
                        this.setState({
                            active_executors:  response.message.users,
                            filterPopup: false,
                            // loaded_map: true,
                            catalogue_list: false,
    ...
    openFilterMap = async () => {
        ...
        async (position) => {
            ...
            console.log(latitude,longitude, 'openFilterMap')
    ...
    redirectToProductSingle = () => {
        let {executor_info_id} = this.state;

        this.setState({
            redirectToSingleProductPopup: false
        })
        this.props.navigation.navigate("CatalogueProductSinglePage", {
            params: executor_info_id,
            redirect_from: 'from map'
        });
    }
    ...
    chooseRadius = async (callback) => {

        let  {selectedRadius} = this.state;

        await this.setState(state => ({
            selectedRadius: callback(state.value),
    ...
    getGeolocation = async () => {
        ...
        Geolocation.getCurrentPosition(
            async (position) => {
                ...
                this.mapRef.current.animateToRegion(initialRegion, 2000);
            }),
            (error) => {
                console.error('Error getting location:', error);
            },
    ...
    render() {
        ...
        if (this.state.redirectToSingleProductPopup) {
            return (
                <ImageBackground resizeMode="cover" source={require('../../../assets/images/popup_img.png')} style={[styles.redirectToSingleProductPopup,{width: '100%', height: windowHeight,  zIndex: 99999999, }]}>
                    <View style={styles.single_product_popup_wrapper}>
                        <TouchableOpacity style={styles.single_product_popup_close_btn} onPress={() => {this.setState({redirectToSingleProductPopup: false})}}>
                            <Svg
                                width={30}
                                height={30}
                                viewBox="0 0 30 30"
                        ...
                        <TouchableOpacity style={styles.go_to_single_product_btn} onPress={() => {this.redirectToProductSingle()}}>
                            <Text style={styles.go_to_single_product_btn_text}>Перейти</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.not_go_to_single_product_btn} onPress={() => {this.setState({redirectToSingleProductPopup: false})}}>
        ...
        if (this.state.filterPopup) {
            return (
                <ImageBackground resizeMode="cover" source={require('../../../assets/images/filter_img.png')} style={[styles.filterPopup,{width: '100%', height: windowHeight,  zIndex: 99999999, flexDirection:'row' }]}>
                    <View style={styles.filter_popup_wrapper}>
                        <View style={styles.filter_popup_img_close_btn_wrapper}>
                            <View style={styles.filter_popup_img}>
                                <Svg width={85} height={70} viewBox="0 0 108 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    
.47 7.959 7.959 0 01-2.824.512 7.78 7.78 0 01-2.165-.3 8.211 8.211 0 01-1.944-.825 8.564 8.564 0 01-2.933-2.974 8.811 8.811 0 01-.825-1.97 8.385 8.385 0 01-.285-2.194c0-.758.095-1.49.285-2.194a8.532 8.532 0 01.824-1.972 8.422 8.422 0 011.286-1.681 8.157 8.157 0 013.592-2.127c.696-.2 1.418-.301 2.165-.301.974 0 1.915.17 2.823.512a7.722 7.722 0 012.46 1.47l-1.669 2.784a4.655 4.655 0 00-1.637-1.158 4.895 4.895 0 00-1.977-.412c-.696 0-1.348.134-1.956.401a5.093 5.093 0 00-2.67 2.706 4.958 4.958 0 00-.395 1.972c0 .698.132 1.355.395 1.97a5.206 5.206 0 001.077 1.605c.454.46.985.824 1.593 1.09.608.268 1.26.402 1.956.402a5.01 5.01 0 001.977-.401 4.78 4.78 0 001.637-1.17l1.67 2.785zm4.988 1.637h-3.153v-15.97h3.153v6.392h6.295v-6.392h3.153v15.97h-3.153v-6.382h-6.295v6.382z" fill="#fff"/>
                                    </G>
                                    <Defs>
                                        <ClipPath id="clip0_314_5025">
                                            <Path   fill="#fff"   transform="translate(33.75 35.1)"   d="M0 0H67.5V16.65H0z"/>
                                        </ClipPath>
                                    </Defs>
                                </Svg>
                            </View>
                            {/*<Text style={styles.filter_popup_title}>*/}
                            {/*    Фильтр*/}
                            {/*</Text>*/}
                            <TouchableOpacity style={styles.filter_popup_close_btn}  onPress={() => {this.setState({
                                filterPopup: false})}}>
                                <Svg  width={30}  height={30}  viewBox="0 0 30 30"  fill="none"  xmlns="http://www.w3.org/2000/svg">
                                    <Path  d="M4.024 5.351a.938.938 0 111.327-1.327l9.65 9.65 9.648-9.65a.938.938 0 111.328 1.327L16.326 15l9.65 9.649a.937.937 0 01-.663 1.602.94.94 0 01-.664-.275L15 16.326l-9.649 9.65a.94.94 0 01-1.53-.304.938.938 0 01.203-1.023L13.674 15l-9.65-9.649z" fill="#fff" />
                                </Svg>
                            </TouchableOpacity>
                        </View>
                        ...
                        >
                            ...
                            <View style={[styles.sign_up_input_title_wrapper, {position: 'relative', elevation: 10, zIndex:9999999999}]}>
                                ...
                                <View style={styles.sign_up_input_title_error_text_wrapper}>
                                    ...
                                    {this.state.selectedItemRadius_error &&
                                    <Text style={[styles.error_text]}>{this.state.selectedItemRadius_error_text}</Text>
                                    }
                                ...
                                <SelectDropdown
                                    data={this.state.radius_info}
                                    onSelect={(selectedItem, index) => {
                                        this.setState({
                                            selectedItemRadius: selectedItem,
                                        })
                                    }}
                                    ...
                                    defaultButtonText={this.state.selectedItemRadius}
                                    buttonStyle={{
                                        width: '100%',
                                        borderRadius: 6,
                                        // borderWidth: 1,
                                    ...
                                    renderDropdownIcon={() => { return (
                                        <View style={{justifyContent: 'flex-end', alignItems: 'flex-end', position: 'absolute', right: 16}}>
                                            <Svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width={18}
                                                height={10}
                            ...
                            <TouchableOpacity style={styles.define_btn} onPress={() => {this.openFilterMap()}}>
                                <View style={styles.define_btn_icon}>
                                    <Svg xmlns="http://www.w3.org/2000/svg" width={15} height={15} viewBox="0 0 15 15" fill="none">
                                        <Path d="M0 5.615a.625.625 0 00.393.59l6 2.401 2.401 6a.624.624 0 00.58.394h.01a.625.625 0 00.578-.411l5-13.75a.624.624 0 00-.801-.801l-13.75 5a.626.626 0 00-.41.578v-.001z" fill="#fff"/>
                                    </Svg>
                                </View>
                                <Text style={styles.define_btn_text}>Определить</Text>
                            </TouchableOpacity>
                            ...
                            { this.state.filter_map ?

                             <View style={{width: '85%',  height: 310, elevation: 10, borderRadius: 10, overflow: 'hidden', marginBottom: 35 }}>

                                    <MapView
                                        style={{ flex: 1,width:'100%', height:'100%', zIndex: 2}}
                                        // initialRegion={this.state.initialRegion}
                                        region={this.state.filter_initialRegion}
                                        // provider='google'
                                        // mapType='standard'
                                        showsScale
                                    ...
                                    <Marker
                                        coordinate={{
                                            latitude: parseFloat(this.state.filter_latitude) ,
                                            longitude: parseFloat(this.state.filter_longitude),
                                        }}
                                    ...
                                    >
                                        <Svg
                                            ...
                                            fill="#000"
                                        >
                                            <Circle cx={256} cy={256} r={256} fill="#579adf" />
                                            <Path
                                                d="M256 0v512c141.385 0 256-114.615 256-256S397.385 0 256 0z"
                                                fill="#579adf"
                                            />
                                            <Path
                                                d="M256 393.143c-75.621 0-137.143-61.522-137.143-137.143S180.379 118.857 256 118.857 393.143 180.379 393.143 256 331.621 393.143 256 393.143zm0-219.429c-45.372 0-82.286 36.913-82.286 82.286s36.913 82.286 82.286 82.286 82.286-36.913 82.286-82.286-36.912-82.286-82.286-82.286z"
                                                fill="#f2f2f4"
                                            />
                                            <Path
                                                d="M256 118.857v54.857c45.374 0 82.286 36.913 82.286 82.286S301.374 338.286 256 338.286v54.857c75.621 0 137.143-61.522 137.143-137.143S331.621 118.857 256 118.857z"
                                                fill="#dfdfe1"
                                            />
                                        </Svg>
                                    </Marker>
                                ...
                                <View style={{backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center', alignSelf: 'flex-start', width: '85%',  height: 310, elevation: 10, borderRadius: 10, overflow: 'hidden', marginBottom: 35 }}>
                            ...
                            <View style={[styles.sign_up_input_title_wrapper, {position: 'relative', elevation: 10, zIndex: 999999}]}>
                                ...
                                <View style={styles.sign_up_input_title_error_text_wrapper}>
                                    ...
                                    <Text style={[styles.error_text]}>{this.state.selectedItemTransport_error_text}</Text>
                                    }
                                ...
                                <SelectDropdown
                                    ...
                                    renderDropdownIcon={() => { return (
                                        <View style={{justifyContent: 'flex-end', alignItems: 'flex-end', position: 'absolute', right: 15}}>
                                            <Svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width={18}
                                                height={10}
                            ...
                            <View style={[styles.sign_up_input_title_wrapper, {position: 'relative', elevation: 10, zIndex: 9999}]}>
                            ...
                            <TouchableOpacity style={styles.apply_button} onPress={() => {this.applyFilter()}}>
                                <Text style={styles.apply_button_text}>Применить</Text>
                            </TouchableOpacity>
        ...
        // if(this.state.location_false_popup) {
        //     return (
        // {/*        <View style={styles.location_false_popup}>*/}
        // {/*            <View style={styles.location_false_popup_wrapper}>*/}
        // {/*                <View style={[styles.filter_popup_img_close_btn_wrapper, {marginBottom: 250}]}>*/}
        // {/*                    <View style={styles.filter_popup_img}>*/}
        ...
        //                         </Svg>
        //                     </View>
        //                     <TouchableOpacity style={styles.filter_popup_close_btn}  onPress={() => {this.setState({location_false_popup: false})}}>
        //                         <Svg  width={30}  height={30}  viewBox="0 0 30 30"  fill="none"  xmlns="http://www.w3.org/2000/svg">
        //                             <Path  d="M4.024 5.351a.938.938 0 111.327-1.327l9.65 9.65 9.648-9.65a.938.938 0 111.328 1.327L16.326 15l9.65 9.649a.937.937 0 01-.663 1.602.94.94 0 01-.664-.275L15 16.326l-9.649 9.65a.94.94 0 01-1.53-.304.938.938 0 01.203-1.023L13.674 15l-9.65-9.649z" fill="#fff" />
        //                         </Svg>
        //                     </TouchableOpacity>
        //                 </View>
        //                 <Text style={styles.location_false_popup_info}>Permission to access location was denied</Text>
        //             </View>
        //         </View>
        //     )
        // }
        ...
        return (
            <SafeAreaView  edges={['right', 'left', 'top']} style={styles.container} >
                ...
                {/*<ImageBackground resizeMode="cover" source={require('../../../assets/images/catalogue_img.png')} style={[{width: '100%', height: '100%',  zIndex: 99999999, justifyContent:'space-between' }]}>*/}
                {/*</ImageBackground>*/}

                    <View  style={[styles.catalogue_header, {backgroundColor:'white'}]}
                       onLayout={(event) => {
                           let {x, y, width, height} = event.nativeEvent.layout;
                           this.setState({
                               catalog_header_height: height
                           })
                       }}
                    >
                        <View style={styles.catalogue_logo_img}>
                            <Svg width={73} height={18} viewBox="0 0 73 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <Path d="M.201 5.419c0-.714.135-1.385.404-2.01A5.271 5.271 0 011.698 1.77 5.239 5.239 0 013.326.65 4.856 4.856 0 015.31.241h7.818v3.456H5.31a1.671 1.671 0 00-1.212.506 1.732 1.732 0 00-.487 1.216c0 .24.044.47.13.686.088.209.207.393.357.554.159.152.34.273.547.361.206.088.428.133.665.133h3.41c.705 0 1.367.136 1.984.409a4.905 4.905 0 011.628 1.108 4.98 4.98 0 011.093 1.65c.27.625.404 1.295.404 2.01 0 .714-.134 1.384-.404 2.01a5.149 5.149 0 01-1.093 1.65 5.157 5.157 0 01-1.628 1.107c-.617.273-1.279.41-1.984.41H1.152V14.05H8.72a1.67 1.67 0 001.2-.493 1.73 1.73 0 00.5-1.228c0-.241-.044-.466-.131-.675a1.597 1.597 0 00-.369-.541 1.575 1.575 0 00-.534-.373 1.67 1.67 0 00-.666-.133H5.31a4.856 4.856 0 01-1.984-.41 5.343 5.343 0 01-1.628-1.107 5.422 5.422 0 01-1.093-1.65A5.12 5.12 0 01.201 5.42zM22.99 17.507h-3.398V3.697H14.47V.242h13.628v3.455h-5.11v13.81zm18.594 0h-11.68V.242h11.68v3.455h-8.27v3.456h5.597v3.455h-5.596v3.443h8.27v3.456zm15.565-1.77a8.657 8.657 0 01-2.661 1.59c-.983.368-2 .553-3.054.553a8.416 8.416 0 01-2.34-.325 8.886 8.886 0 01-2.104-.89 9.257 9.257 0 01-3.172-3.215 9.525 9.525 0 01-.89-2.132 9.058 9.058 0 01-.31-2.371c0-.82.103-1.61.31-2.372a9.222 9.222 0 01.89-2.131 9.101 9.101 0 011.39-1.818 8.816 8.816 0 013.886-2.3 8.415 8.415 0 012.34-.325 8.61 8.61 0 013.054.554c.982.361 1.87.89 2.661 1.59l-1.806 3.009a5.034 5.034 0 00-1.77-1.252 5.295 5.295 0 00-2.139-.446c-.752 0-1.457.145-2.115.434a5.51 5.51 0 00-2.887 2.925 5.359 5.359 0 00-.428 2.132c0 .754.143 1.464.428 2.13a5.63 5.63 0 001.165 1.734 5.509 5.509 0 001.722 1.18 5.197 5.197 0 002.115.434 5.42 5.42 0 002.139-.434 5.169 5.169 0 001.77-1.264l1.806 3.01zm5.394 1.77h-3.41V.242h3.41v6.91h6.809V.243h3.41v17.265h-3.41v-6.899h-6.809v6.899z"  fill="#F60"/>
                            </Svg>
                        </View>
                        <View style={styles.catalogue_search_input_btn_filter_btn_wrapper}>
                            <View  style={styles.catalogue_search_input_filter_btn}>
                                ...
                                >
                                    <Svg width={40} height={40} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <Rect width={40} height={40} rx={10} fill="#F60" />
                                        <Path d="M30.438 14.25h-3.204c-.39-1.797-1.953-3.125-3.828-3.125-1.875 0-3.437 1.328-3.828 3.125H8.563v1.563h11.015c.39 1.796 1.953 3.124 3.828 3.124 1.875 0 3.438-1.328 3.828-3.125h3.203V14.25zm-7.032 3.125c-1.328 0-2.343-1.016-2.343-2.344 0-1.328 1.015-2.344 2.343-2.344s2.344 1.016 2.344 2.344c0 1.328-1.016 2.344-2.344 2.344zM8.563 26.75h3.203c.39 1.797 1.953 3.125 3.828 3.125 1.875 0 3.437-1.328 3.828-3.125h11.015v-1.563H19.422c-.39-1.796-1.953-3.125-3.828-3.125-1.875 0-3.438 1.329-3.828 3.125H8.562v1.563zm7.03-3.125c1.329 0 2.345 1.016 2.345 2.344 0 1.328-1.016 2.343-2.344 2.343-1.328 0-2.344-1.015-2.344-2.343s1.016-2.344 2.344-2.344z"  fill="#fff"/>
                                    </Svg>
                                </TouchableOpacity>
                                <Text
                                    style={{fontWeight: '400',fontSize: 18, color: '#333333'
                                }}
                                >
                                    Фильтр
                                </Text>
                                ...
                                {/*    onChangeText={(val) => this.setState({searchInput: val})}*/}
                            ...
                            {/*        <Path*/}
                            {/*            d="M19.416 26.75c1.85 0 3.645-.62 5.101-1.758l4.58 4.579 1.473-1.473-4.58-4.58a8.284 8.284 0 001.76-5.101c0-4.595-3.739-8.334-8.334-8.334s-8.333 3.739-8.333 8.334 3.739 8.333 8.333 8.333zm0-14.583a6.256 6.256 0 016.25 6.25 6.256 6.256 0 01-6.25 6.25 6.256 6.256 0 01-6.25-6.25 6.256 6.256 0 016.25-6.25z"*/}
                            {/*            fill="#333"*/}
                            {/*        />*/}
                            {/*    </Svg>*/}
                            {/*</TouchableOpacity>*/}
                        </View>
                        <View style={styles.catalogue_list_map_buttons_wrapper}>
                            <TouchableOpacity style={[styles.catalogue_list_map_button, this.state.catalogue_list ? styles.activeBackground : {} ]}
                                              onPress={() => {
                                                  this.redirectToExecutorsLists()
                                              }}
                            >
                                <View style={styles.catalogue_list_map_button_svg}>
                                    <Svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <Path d="M3.5 4A1.5 1.5 0 002 5.5v2A1.5 1.5 0 003.5 9h2A1.5 1.5 0 007 7.5v-2A1.5 1.5 0 005.5 4h-2zM3 5.5a.5.5 0 01.5-.5h2a.5.5 0 01.5.5v2a.5.5 0 01-.5.5h-2a.5.5 0 01-.5-.5v-2zM9.5 5a.5.5 0 100 1h8a.5.5 0 000-1h-8zm0 2a.5.5 0 100 1h6a.5.5 0 000-1h-6zm-6 4A1.5 1.5 0 002 12.5v2A1.5 1.5 0 003.5 16h2A1.5 1.5 0 007 14.5v-2A1.5 1.5 0 005.5 11h-2zM3 12.5a.5.5 0 01.5-.5h2a.5.5 0 01.5.5v2a.5.5 0 01-.5.5h-2a.5.5 0 01-.5-.5v-2zm6.5-.5a.5.5 0 000 1h8a.5.5 0 000-1h-8zm0 2a.5.5 0 000 1h6a.5.5 0 000-1h-6z" fill="#000"/>
                                    </Svg>
                                </View>
                                <Text style={styles.catalogue_list_map_button_text}>Список</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.catalogue_list_map_button, this.state.catalogue_map ? styles.activeBackground : {} ]} onPress={() => this.openMap()}>

                                <View style={styles.catalogue_list_map_button_svg}>
                                    <Svg width={18} height={18} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <Path d="M14.063 7.313a5.063 5.063 0 00-10.126 0c0 2.076 1.662 4.783 5.063 8.025 3.4-3.242 5.063-5.949 5.063-8.025zM9 16.874c-4.125-3.75-6.188-6.938-6.188-9.563a6.187 6.187 0 0112.376 0c0 2.625-2.063 5.813-6.188 9.563z" fill="#000"/>
                                        <Path d="M9 7.875a1.125 1.125 0 100-2.25 1.125 1.125 0 000 2.25zM9 9a2.25 2.25 0 110-4.5A2.25 2.25 0 019 9zm6.075 3.375l1.8 4.5h-5.063V15.75H6.189v1.125H1.125l1.8-4.5h12.15zm-1.212 0H4.137l-1.35 3.375h12.426l-1.35-3.375z" fill="#000"/>
                                    </Svg>
                                </View>
                                <Text style={styles.catalogue_list_map_button_text}>Карта</Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    {/*<View style={[styles.catalogue_main_wrapper, {height: windowHeight - 200, position:'absolute', top: this.state.catalog_header_height - 30}]} >*/}
                    ...
                    {/*        <Text style={styles.catalogue_lists_item_title}>Категории</Text>*/}
                            ...
                            {/*                <Image style={styles.catalogue_list_img_child}  source={item.img} />*/}
                            {/*            </View>*/}
                            ...
                            {/*    numColumns={3}*/}
                            {/*    columnWrapperStyle={{flex: 1, width: '100%', justifyContent: "flex-start" }}*/}
                    ...
                    {/*    <View style={styles.catalogue_lists_items_wrapper}>*/}
                    {/*        <TouchableOpacity style={{marginBottom: 20, flexDirection:'row'}} onPress={() => {this.setState({show_sub_categories: false, show_categories: true})}}>*/}
                    ...
                    {/*            <Text style={{position:'relative', top: 4}}>Назад</Text>*/}
                    {/*        </TouchableOpacity>*/}
                    {/*        <Text style={styles.catalogue_lists_item_title}>{this.state.main_title}</Text>*/}
                    ...
                    {this.state.loaded_map &&
                        <View style={{backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center', alignSelf: 'center', width: '100%',  height: windowHeight - 210, position:'absolute', top: this.state.catalog_header_height - 45 }}>
                    ...
                    {!this.state.loaded_map &&
                        ...
                        <View style={{width: '100%',  height: windowHeight - 210, position:'absolute', top: this.state.catalog_header_height - 15 }}>
                        <MapView
                            style={{ flex: 1,width:'100%', height:'100%', zIndex: 2}}
                            // initialRegion={this.state.initialRegion}
                        ...
                        >
                            ...
                            {this.state.active_executors.map((item, index) => {
                                ...
                                return (
                                    ...
                                    <Marker
                                        ...
                                        onPress={() => {
                                            this.openUserSinglePage(item.id)
                                        }}
                            ...
                            {/*{this.state.filter_users.map((item, index) => {*/}
                            ...
                            {/*            }}*/}
                            {/*            onPress={() => {*/}
                            {/*                this.openUserSinglePage(item)*/}
                            {/*            }}*/}

                            {/*        >*/}
                            {/*            <Svg width={22} height={28} viewBox="0 0 22 28" fill="none" xmlns="http://www.w3.org/2000/svg">*/}
                            {/*                <Path d="M11 0A11.013 11.013 0 000 11a10.889 10.889 0 002.216 6.6s.3.395.349.452L11 28l8.439-9.953c.044-.053.345-.447.345-.447l.001-.003A10.885 10.885 0 0022 11 11.013 11.013 0 0011 0zm0 15a4 4 0 110-8 4 4 0 010 8z" fill="#6A43B1"/>*/}
                            {/*            </Svg>*/}
                            {/*        </Marker>*/}
                        ...
                        <View style={[styles.map_buttons_wrapper, {bottom: Platform.OS === 'ios' ? 50 : 10}]}>

                            <TouchableOpacity
                                onPress={() => {this.props.navigation.navigate('MyJobTender')}}
                            >
                                <Svg width={53} height={53} viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <G filter="url(#filter0_d_175_3766)"><Rect x={4} y={1} width={45} height={45} rx={10} fill="#F60" /><Path fillRule="evenodd" clipRule="evenodd" d="M26.016 6.063c-.919.297-1.582 1.03-1.661 1.835l-.028.285H22.82c-2.113 0-2.01-.111-2.01 2.17 0 1.7.024 1.828.381 2.043l.212.128h5.245c5.712 0 5.538.01 5.77-.334.098-.147.113-.334.13-1.714.021-1.666-.005-1.878-.267-2.118-.157-.144-.167-.145-1.72-.175L29 8.153l-.047-.327c-.104-.717-.674-1.407-1.382-1.673-.418-.158-1.207-.203-1.555-.09zm-11.142 2.32c-.33.15-.579.399-.746.744-.097.202-.105 1.177-.12 14.873-.017 16.104-.042 15.014.349 15.474.101.12.327.287.5.372l.317.154h11.508l11.509-.001.307-.14c.168-.077.385-.23.48-.341.381-.441.368-.303.388-3.972.01-1.844.002-3.395-.018-3.445-.027-.069-.192.06-.642.497l-.607.59v2.71c0 2.029-.018 2.728-.073 2.782-.106.104-22.575.104-22.681 0-.056-.055-.073-3.365-.073-14.536 0-7.955.017-14.507.037-14.558.032-.083.243-.095 1.735-.095h1.698l.004.313.02 1.65c.01.736.04 1.418.066 1.516.1.367.338.734.665 1.026.628.56.08.519 7.03.537 5.376.014 6.155.005 6.483-.077.64-.16 1.092-.533 1.4-1.158l.19-.387.02-1.71.02-1.71h1.657c1.207 0 1.676.02 1.73.072.055.054.072 1.38.072 5.604V20.7l.64-.623.64-.623-.003-4.907c-.002-3.178-.026-5.007-.067-5.192-.086-.385-.381-.745-.776-.946l-.326-.166h-2.519c-1.723 0-2.52.02-2.52.062a5 5 0 00.095.466c.076.326.09.746.076 2.183-.018 1.769-.019 1.78-.164 1.979-.28.382.038.365-6.503.364-5.546 0-5.966-.007-6.16-.104a1.12 1.12 0 01-.335-.271c-.12-.16-.128-.257-.145-1.923-.015-1.411 0-1.843.076-2.203a7.13 7.13 0 00.095-.5c0-.03-1.078-.053-2.511-.053-2.507 0-2.512.001-2.818.14zm13.8 13.406l-3.732 3.661-2.005-1.957-2.004-1.958-.822.803-.821.803 2.83 2.764 2.829 2.764 4.578-4.474 4.578-4.474-.818-.801c-.45-.441-.832-.8-.849-.797-.017.003-1.71 1.653-3.763 3.666zm13.047-2.68a1.237 1.237 0 00-.304.154c-.258.174-1.796 1.659-1.796 1.734 0 .034.98 1.019 2.177 2.188l2.177 2.126.891-.877c.895-.88 1.035-1.063 1.108-1.436.094-.48.018-.582-1.655-2.228-.86-.846-1.65-1.575-1.759-1.62-.19-.081-.593-.1-.839-.04zm-8.252 7.852l-5.33 5.219-.264.832c-.145.458-.353 1.1-.462 1.428-.11.327-.41 1.25-.669 2.05-.432 1.341-.463 1.468-.384 1.606.05.088.151.157.243.168.086.01.77-.174 1.52-.41.75-.234 1.692-.525 2.093-.646.402-.122 1.091-.336 1.531-.477l.8-.256 5.318-5.198 5.345-5.228c.028-.03-4.322-4.306-4.38-4.306-.017 0-2.43 2.348-5.361 5.218zm5.204-3.52a.453.453 0 01.096.282c0 .17-.41.588-4.186 4.278-3.773 3.685-4.206 4.09-4.379 4.09-.245 0-.383-.136-.383-.376 0-.17.405-.585 4.185-4.278 3.78-3.693 4.204-4.089 4.379-4.089.106 0 .236.042.288.094zm-7.33 12.516c0 .017-.51.188-1.134.38l-1.134.347-.57-.557-.57-.558.37-1.124.37-1.124 1.333 1.302c.734.716 1.335 1.316 1.335 1.334z" fill="#fff"/></G>
                                    <Defs></Defs>
                                </Svg>
                            </TouchableOpacity>

                            <TouchableOpacity style={styles.create_order_btn}  onPress={() => {this.redirectToCreateAnOrderCategory()}}>
                                <View style={styles.create_order_btn_svg}>
                                    <Svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <Path d="M10 6.667V10m0 0v3.333M10 10h3.334M10 10H6.667" stroke="#fff" strokeWidth={2} strokeLinecap="round"/>
                                        <Path d="M10 18.333a8.333 8.333 0 100-16.666 8.333 8.333 0 000 16.666z" stroke="#fff" strokeWidth={2}/>
                                    </Svg>
                                </View>
                                <Text style={styles.create_order_btn_text}>Создать тендер</Text>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => {this.getGeolocation()}}>
                                <Svg width={53} height={53} viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg"><G filter="url(#filter0_d_168_7514)"><Rect x={4} y={1} width={45} height={45} rx={10} fill="#fff" /></G>
                                    <Path d="M15.5 21.36a.875.875 0 00.55.827l8.401 3.36 3.361 8.403a.876.876 0 00.813.55h.014a.875.875 0 00.809-.576l7-19.25a.875.875 0 00-1.122-1.122l-19.25 7a.876.876 0 00-.576.809z" fill="#F60"/>
                                    <Defs></Defs>
                                </Svg>
                            </TouchableOpacity>
                        </View>
...
const styles = StyleSheet.create({
    ...
    dop_oborudivanie_plus_button: {
        ...
        justifyContent: 'center',
        borderWidth: 1,
        borderColor: 'background: #333333',
        borderRadius: 6
    },
    location_false_popup: {
        backgroundColor:  'rgba(255, 255, 255, 0.25)',
        shadowColor: '#000000',
        shadowOffset: { width: 0, height: 4 },
        shadowOpacity: 0.25,
